            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-6 relative h-[500px] md:h-[600px] flex items-center justify-center">
                        ...
                        <div className="absolute top-35 md:top-25 left-5  w-1/2 aspect-video z-25 reveal active group ">
                        ...
                        <div className="absolute top-1/4 right-5 w-2/5 aspect-[3/4] z-20 reveal active group">
                        ...
                        <div className="absolute bottom-4 left-8 w-2/5 aspect-square z-30 reveal active group">
                        ...
                        <div className="absolute bottom-1/4 left-1/4 w-1/3 aspect-[4/5] z-15 reveal active group">
                            ...
                            <img
                                src={Selfie}
                                alt="Selfie"
                                className="relative rounded-2xl shadow-lg w-full h-full object-cover border border-white/5 opacity-80 group-hover:opacity-100 
                                group-hover:border-primary group-hover:scale-[1.02] transition-all duration-700"
                            />
                        </div>
                    ...
                    {/* Text Column */}
                    <div className="lg:col-span-6 reveal active lg:pl-10">
                        <div className="inline-block px-4 py-1 rounded-full bg-primary/10 border border-primary/20 mb-8">
                            <span className="text-primary text-xs font-bold uppercase tracking-widest">The Persona</span>
                        </div>
                        <h2 className="text-4xl md:text-6xl font-bold text-white mb-10 font-heading leading-tight">
                            Curiosity-driven <br />
                            <span className="text-primary italic">innovation.</span>
                        </h2>

                        <div className="space-y-6 max-w-xl">
                            <p className="text-xl text-white/90 leading-relaxed font-heading">
                                I'm Knowledge Udoh, a Developer passionate about crafting digital experiences that resonate.
                            </p>
                            <p className="text-lg text-theme/40 leading-relaxed font-medium">
                            ...
                            <p className="text-lg text-theme/40 leading-relaxed">
                                From leading tech solutions at Avera to developing seamless mobile experiences at Rinku, my focus is always on the intersection of human-centric design and powerful performance.
                            </p>
                        </div>
